...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    // Here you would integrate with your Express.js backend
          ...
          >
            ...
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                className="flex items-center gap-4 p-4 rounded-lg bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 hover:shadow-lg transition-all"
              >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full flex items-center justify-center gap-3 px-8 py-3 bg-blue-600 dark:bg-blue-500 text-white rounded-lg font-semibold hover:bg-blue-700 dark:hover:bg-blue-600 transition-all shadow-lg hover:shadow-xl"
              >
                <Send size={20} />
                Send Message
              </motion.button>
